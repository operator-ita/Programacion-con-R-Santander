...
setwd("C:/Users/Elias Guzmán/Documents/GitHub/R/Programacion-con-R-Santander/Sesion-01/Data") # Depende del usuario

# La funcion read.csv será util para leer fichero .csv
