...
# Desarrollo
# Se tiene una serie de códigos los cuales deberán irse corriendo línea a línea, recordar que siempre se ejecuta una línea presionando Ctrl + Enter
...
# Nota: Son operaciones elemento a elemento
a <- c(1, 2)
b <- c(1, 2)
